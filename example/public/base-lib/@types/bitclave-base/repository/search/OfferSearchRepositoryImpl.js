...
var OfferSearchRepositoryImpl = /** @class */ (function () {
    ...
    OfferSearchRepositoryImpl.prototype.getSearchResultByOfferSearchId = function (clientId, offerSearchId) {
        var _this = this;
        return this.transport.sendRequest(this.OFFER_SEARCH_ADD_API + ("?offerSearchId=" + offerSearchId), HttpMethod_1.HttpMethod.Get).then(function (response) { return _this.jsonToListResult(response.json); });
    };
