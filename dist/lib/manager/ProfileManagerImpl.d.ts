...
export declare class ProfileManagerImpl implements ProfileManager {
    ...
    private account;
    private logger;
    constructor(clientDataRepository: ClientDataRepository, authAccountBehavior: Observable<Account>, encrypt: MessageEncrypt, decrypt: MessageDecrypt, signer: MessageSigner, loggerService?: Logger);
