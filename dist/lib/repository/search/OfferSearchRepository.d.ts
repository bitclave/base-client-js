...
export declare enum OfferSearchRequestInterestMode {
    must = "must",
    prefer = "prefer"
}
export interface OfferSearchRepository {
    ...
    getUserOfferSearches(clientId: string, page?: number, size?: number, unique?: boolean, searchIds?: Array<number>, state?: Array<OfferResultAction>, sort?: SortOfferSearch, interaction?: boolean): Promise<Page<OfferSearchResultItem>>;
